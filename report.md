...
- [NC Issues](#nc-issues)
  ...
  - [NC-2: Define and use `constant` variables instead of using literals](#nc-2-define-and-use-constant-variables-instead-of-using-literals)
  - [NC-3: Event is missing `indexed` fields](#nc-3-event-is-missing-indexed-fields)
  - [NC-4: Large literal values multiples of 10000 can be replaced with scientific notation](#nc-4-large-literal-values-multiples-of-10000-can-be-replaced-with-scientific-notation)
...
## NC-2: Define and use `constant` variables instead of using literals
...
## NC-4: Large literal values multiples of 10000 can be replaced with scientific notation

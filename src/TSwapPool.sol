...
contract TSwapPool is ERC20 {
    ...
    /*//////////////////////////////////////////////////////////////
                               MODIFIERS
    //////////////////////////////////////////////////////////////*/
    // explain - deadline passed in should be deadline specified in a swap
    // so if the timestamp of current block is > than deadline, should revert
    // ok
    ...
    /// question - should it be the product????
    ...
    // @vulnerability it's not checking the deadline
    // severe disruption of funcitonality
    // impact - high
    // likelyhood - high, it can happen everytime a user call this
    //
    function deposit(
        uint256 wethToDeposit,
        uint256 minimumLiquidityTokensToMint,
        uint256 maximumPoolTokensToDeposit,
        uint64 deadline // @-info unused parameters
    )
        external
        ...
        private
    {
        ...
        // @-medium high this is backwords
        // likelyhood high always happening
        // impact medium-high, giving definitely wrong info
    ...
    /*//////////////////////////////////////////////////////////////
                              GET PRICING
    //////////////////////////////////////////////////////////////*/
    // @audit-notes missing natspec
    // understand - given an input amount,return an output, netting the fees
        ...
        returns (uint256 outputAmount)
    {
        ...
        // @-note avoid using magic numbers
    ...
    // @audit-notes missing natspec (also for other functions)
    // understand - given an output amount,return an input
    ...
    {
        // @-vulnerability 10000 should be 1000! use magic number
        // impact: high users are charged a lot
        // likelyhiid high, happening all the time
        return ((inputReserves * outputAmount) * 10000) / ((outputReserves - outputAmount) * 997);
    }

    // @audit-note missing natspec
    // understand give an exact input, it swaps it
    function swapExactInput(
        ...
        returns (
            ...
            // Low vulnerability bc gives bad info, super low impact
            uint256 output
        )
    {
     ...
     */
    // @-vulnerability missing check on the final output amount, slippage vulnerability
